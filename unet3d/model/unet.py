...
def unet_model_3d(input_shape, pool_size=(2, 2, 2), kernel_size=(3, 3, 3), n_labels=1, initial_learning_rate=0.00001, deconvolution=False, dilation=1,
                  depth=4, n_base_filters=32, metrics=dice_coeff, batch_normalization=False, activation_name="sigmoid", build_model=True):
    """
    ...
    for layer_depth in range(depth):
        ...
        layer2 = create_convolution_block(input_layer=layer1, n_filters=n_base_filters*(2**layer_depth)*2, kernel=kernel_size, dilation=dilation,
                                          batch_normalization=batch_normalization)
...
def create_convolution_block(input_layer, n_filters, batch_normalization=False, kernel=(3, 3, 3), activation=None, dilation=1,
    ...
    :return:
    """
    layer = Conv3D(n_filters, kernel, padding=padding, strides=strides, dilation_rate=dilation)(input_layer)
