...
config["dilation"] = 1 # pool size for the max pooling operations
...
config["model_file"] = "model_USOVA3D_v032.h5"
...
#        plt.show()
    ...
    print("Generated_Y_Shape: {}".format(next_Y.shape))
...
#    plt.show()    
    ...
    if not overwrite and os.path.exists(config["model_file"]):
        ...
        if config['add_label_edge']:
            n_labels*=2
        model = unet_model_3d(input_shape=None,
                              n_labels=n_labels,
